...
export default function PrivacyPage() {
  return (
    <LegalPage title="Politique de confidentialité" updated={UPDATED}>
      <Section title="En une page">
        <p>
          Jotna School est une application scolaire destinée à des enfants de 6
          à 11 ans. Nous en avons écrit le fonctionnement de la manière la plus
          économe possible : un élève inscrit par son école n&apos;a{" "}
          <Strong>
            ni adresse électronique, ni numéro de téléphone, ni photo
          </Strong>{" "}
          chez nous. Il n&apos;y a <Strong>aucune publicité</Strong>,{" "}
          <Strong>aucun outil de mesure d&apos;audience</Strong> et{" "}
          <Strong>aucun pisteur</Strong>, ni dans l&apos;application mobile, ni
          sur le site.
        </p>
      </Section>
      ...
      <Section title="Qui est responsable du traitement">
        <p>
          Jotna School, éditeur de la plateforme. Pour toute question ou pour
          exercer vos droits :{" "}
          <a
        ...
        <p>
          ...
          détermine l&apos;usage scolaire qui est fait de la plateforme et reste
      ...
      <Section title="Ce que nous collectons">
        ...
        />
        <p>
          Pour un parent ou un membre du personnel, qui crée lui-même son compte
          : son nom, son adresse électronique, et ses préférences d&apos;envoi
          de courriels.
        </p>
      ...
      <Section title="Ce qui reste sur l'appareil">
        ...
        <p>
          ...
          <Strong>s&apos;effacent au bout de quatorze jours</Strong>, ou plus
          tôt si l&apos;abonnement de l&apos;école s&apos;arrête. Les réponses
          non envoyées, elles, ne s&apos;effacent jamais tant qu&apos;elles
          n&apos;ont pas été transmises : c&apos;est du travail d&apos;enfant,
          et nous avons choisi de ne pas le jeter. « Changer d&apos;élève »
          efface ce qui a déjà été transmis et laisse le reste partir plus tard.
        </p>
        <p>
          Désinstaller l&apos;application efface tout ce qui se trouve sur
          l&apos;appareil, y compris les réponses qui n&apos;auraient pas encore
          été envoyées.
        </p>
      </Section>
      ...
      <Section title="L'aide par intelligence artificielle">
        <p>
          ...
          travail de l&apos;élève — sa réponse, ou ses réponses fausses sur un
          exercice — est envoyé à notre prestataire d&apos;IA{" "}
          <Strong>OpenAI</Strong>, dont les serveurs se situent hors du Sénégal.
          Rien n&apos;est envoyé sous le nom de l&apos;enfant : nous ne
          transmettons ni son nom, ni son école, ni son code.
        </p>
        <p>
          <Strong>
          ...
          représentants légaux ; un parent rattaché à l&apos;élève peut refuser
          pour son enfant depuis ses réglages, et son refus s&apos;applique
          immédiatement et l&apos;emporte sur la déclaration de l&apos;école.
          Sans consentement, l&apos;aide par IA est simplement indisponible :
      ...
      <Section title="Combien de temps nous les gardons">
        <p>
          Les données de progression d&apos;un élève sont conservées tant que
          son école l&apos;a inscrit, puis pendant la durée nécessaire à
          l&apos;établissement du bilan de l&apos;année scolaire. Un compte de
          parent ou de personnel est conservé tant qu&apos;il est actif.
        </p>
      </Section>

      <Section title="Vos droits">
        <p>
          Conformément à la loi sénégalaise n° 2008-12 du 25 janvier 2008 sur la
          protection des données à caractère personnel, vous pouvez demander
          l&apos;accès aux données concernant votre enfant, leur rectification,
          leur effacement, ou vous opposer à un traitement. Écrivez à{" "}
          <a
            className="font-medium text-amber-700 hover:underline"
            href={`mailto:${CONTACT}`}
          >
          ...
          d&apos;abord à celui-ci : c&apos;est lui qui a saisi son inscription.
        </p>
        <p>
          Vous pouvez également saisir la Commission de protection des données
      ...
      <Section title="Modifications">
        <p>
          ...
          avec sa date. Un changement qui élargirait l&apos;usage des données
          des enfants sera porté à la connaissance des écoles et des parents
          rattachés avant d&apos;entrer en vigueur.
        </p>
      </Section>

      <Caveat>
        Ce document décrit fidèlement le fonctionnement du logiciel. Il ne
        constitue pas un avis juridique et doit être relu par un conseil avant
        toute soumission aux boutiques d&apos;applications.
      </Caveat>
    </LegalPage>
  );
}
