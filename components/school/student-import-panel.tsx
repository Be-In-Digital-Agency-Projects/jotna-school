 ...
 *
 * VIT DANS UN COMPOSANT PARTAGÉ PARCE QUE DEUX ESPACES L'OUVRENT : `/admin`,
 * qui dépanne n'importe quelle école, et `/directeur`, où l'école importe ses
 * propres élèves. Le cadrage n'est pas ici — `studentImport.openImport` et
 * `latestJob` appellent `access.callerAuthorityOverSchool` et refusent une école
 * que l'appelant ne dirige pas. Deux copies de cet écran auraient divergé, et la
 * plus ancienne aurait continué de tourner.
 *
